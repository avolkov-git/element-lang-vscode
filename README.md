...
Светлая и темная палитры адаптированы под соответствующий тип темы VS Code и сохраняют читаемое разделение между ключевыми словами, типами, именами методов, строками и служебными конструкциями языка.

### Светлая тема

![XBSL light theme screenshot](assets/screenshot-light.png)

### Темная тема

![XBSL dark theme screenshot](assets/screenshot-dark.png)

## Лицензия

Расширение распространяется по лицензии MIT. Подробные условия указаны в [LICENSE](LICENSE).
